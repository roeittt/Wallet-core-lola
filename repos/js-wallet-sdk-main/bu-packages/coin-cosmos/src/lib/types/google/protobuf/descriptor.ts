...
import { DeepPartial, Exact, isSet } from '../../cosmos/tx/v1beta1/tx';

export const protobufPackage = "google.protobuf";

/**
 * The protocol compiler can output a FileDescriptorSet containing the .base
 * files it parses.
 */
...
/** Describes a complete .base file. */
...
export interface FieldDescriptorProto {
   ...
   * This can be useful for round-tripping the .base file. For consistency we
...
export interface FileOptions {
  /**
   * Sets the Java package where classes generated from this .base will be
   * placed.  By default, the base package is used, but this is often
   * inappropriate because base packages do not normally start with backwards
   * domain names.
   */
  javaPackage: string;
  /**
   * Controls the name of the wrapper Java class generated for the .base file.
   * That class will always contain the .base file's getDescriptor() method as
   * well as any top-level extensions defined in the .base file.
   * If java_multiple_files is disabled, then all the other classes from the
   * .base file will be nested inside the single wrapper outer class.
   */
  javaOuterClassname: string;
  /**
   * If enabled, then the Java code generator will generate a separate .java
   * file for each top-level message, enum, and service defined in the .base
  ...
  /**
   * Sets the Go package where structs generated from this .base will be
   * placed. If omitted, the Go package will be derived from the following:
   *   - The basename of the package import path, if provided.
   *   - Otherwise, the package statement in the .base file, if present.
   *   - Otherwise, the basename of the .base file, without extension.
   */
  goPackage: string;
  /**
  ...
  deprecated: boolean;
  /**
   * Enables the use of arenas for the base messages in this file. This applies
   * only to generated classes for C++.
   */
  ccEnableArenas: boolean;
  /**
   * Sets the objective c class prefix which is prepended to all objective c
   * generated classes from this .base. There is no default.
   */
  objcClassPrefix: string;
  /** Namespace for generated classes; defaults to the package. */
  csharpNamespace: string;
  /**
   * By default Swift generators will take the base package and CamelCase it
   ...
   * from this .base. Default is empty.
   */
   ...
   * Default is empty. When this option is empty, the base file name will be
...
export interface MessageOptions {
   ...
   *
   * NOTE: Do not set the option in .base files. Always use the maps syntax
   * instead. The option should only be implicitly set by the base compiler
   * parser.
   */
  mapEntry: boolean;
  /** The parser stores options it doesn't recognize here. See above. */
 ...
 * extension (denoted with parentheses in options specs in .base files).
...
export interface SourceCodeInfo {
  /**
   * A Location identifies a piece of source code in a .base file which
 ...
 * source file, but may contain references to different source .base files.
 */
export interface GeneratedCodeInfo {
  /**
   * An Annotation connects some span of text in generated code to an element
   * of its generating .base file.
   */
...
export interface GeneratedCodeInfo_Annotation {
  /**
   * Identifies the element in the original source .base file. This field
   * is formatted the same as SourceCodeInfo.Location.path.
   */
  path: number[];
  /** Identifies the filesystem path to the original source .base. */
  sourceFile: string;
  /**
