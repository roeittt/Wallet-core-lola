...
describe('eth api', () => {
  test('signCommonMsg', async () => {
    ...
    sig = await wallet.signCommonMsg({
      ...
      message: { text: 'ed25519:G6mk3vRxgjFA4gjHDaNvxqdpofgkrkon6LqhsnLgmRVB' },
    });
    expect(sig).toEqual(
  ...
  test('validPrivateKey', async () => {
    ...
    expect(
      (await wallet.validPrivateKey({ privateKey: '0x' + privateKey })).isValid
    ).toEqual(true);
    expect(
      (await wallet.validPrivateKey({ privateKey: '0X' + privateKey })).isValid
    ).toEqual(true);
    ...
    if (txParams.type == null || txParams.type === 1) {
      ...
      if (tokenAddress) {
        data =
          ...
          Array.prototype.map
            .call(
              abi.RawEncode(['address', 'uint256'], [toAddress, value]),
...
describe('eth walLet', () => {
  ...
  test('getHardWareSignedTransaction', async () => {
    ...
    const result = await wallet.getHardWareSignedTransaction({ raw, r, s, v });
  ...
  test('signAuthorizationListItem without privateKey', async () => {
    ...
    await expect(wallet.signAuthorizationListItem(signParams)).rejects.toThrow(
  ...
  test('legacy deploy contract', async () => {
    ...
    const tx = await wallet.signTransaction(signParams);
    const expected =
      '';
...
describe('eth api additional coverage', () => {
  ...
  test('validAddress with various formats', () => {
    ...
    expect(result1.address).toBe('0xD74c65aD81aA8537327e9Ba943011A8cEc7a7B6b');
    ...
    expect(result2.address).toBe('0xD74c65aD81aA8537327e9Ba943011A8cEc7a7B6b');
