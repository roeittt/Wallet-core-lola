...
const poseidonHashMany = signUtil.schnorr.stark.poseidonHashMany;
 ...
 * @returns {bigint} encoded data
 */
export function encodeResourceBoundsL2(bounds: RPCSPEC08.ResourceBounds): bigint {
  return (
 ...
 */
export function hashFeeField(tip: BigNumberish, bounds: RPCSPEC08.ResourceBounds) {
