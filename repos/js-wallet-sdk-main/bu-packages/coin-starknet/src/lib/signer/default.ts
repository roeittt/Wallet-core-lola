import {
  ...
  DeployAccountSignerDetails, ETransactionVersion2, ETransactionVersion3,
...
export class Signer implements SignerInterface {
  ...
  public async signMessage(typedData: TypedData, accountAddress: string): Promise<Signature> {
    ...
    const res = await this.signRaw(msgHash)
  ...
  protected async signRaw(msgHash: string): Promise<any> {
    return {
      signature: starkCurve.sign(msgHash, this.pk),
      hash: msgHash,
    };
  }
}
